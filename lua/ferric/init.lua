...
local function get_groups()
	...
	local groups = {
		...
		BlinkCmpDoc = { fg = p.limestone, bg = p.anvil },
		BlinkCmpDocBorder = { fg = p.anvil, bg = p.anvil },
		BlinkCmpDocSeparator = { fg = p.smelt, bg = p.anvil },
		BlinkCmpDocCursorLine = { bg = p.crucible },
		BlinkCmpSignatureHelp = { fg = p.limestone, bg = p.anvil },
		BlinkCmpSignatureHelpBorder = { fg = p.anvil, bg = p.anvil },
